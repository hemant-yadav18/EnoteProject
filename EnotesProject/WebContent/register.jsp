...
<body>
	...
	<div class="container-fluid bg-dark mt-1">
		<p class="text-center text-white">Note :Any Error occur then
			contact :- Admin . Designed and devloped by <b style="color: blue;">Hemant yadav</b></p>
		<p class="text-center text-white">All Reight Reserved:-
			Hemanty4472@gmail.com 2024-2025</p>
	</div>
</body>
</html>