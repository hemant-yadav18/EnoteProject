	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				...
				%>
				<div class="card mt-3">
					<img alt="" src="img/paper2.png" class="card-img-top mt-2 mx-auto"
					...
					<div class="card-body p-4">
						...
						<p>
							<b class="text-success">Publised By: <%= user3.getName() %> </b></br> <b
								class="text-primary"></b>
						</p>

						<p>

							<b class="text-success">Publised Date: <%= po.getPdate() %> </b></br> <b
